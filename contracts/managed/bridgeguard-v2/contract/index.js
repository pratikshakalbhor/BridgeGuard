...
export class Contract {
      ...
      registerBridge: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerBridge',
                                     ...
                                     'bridgeguard-v2.compact line 86 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      evaluateBridge: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('evaluateBridge',
                                     'argument 1 (as invoked from Typescript)',
                                     'bridgeguard-v2.compact line 123 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      flagBridge: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('flagBridge',
                                     'argument 1 (as invoked from Typescript)',
                                     'bridgeguard-v2.compact line 151 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(bridgeId_0) === 'bigint' && bridgeId_0 >= 0n && bridgeId_0 <= 18446744073709551615n)) {
  ...
  _getRiskIntel_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('getRiskIntel',
                                 'return value',
                                 'bridgeguard-v2.compact line 55 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
  ...
  _computeBaseScore_0(audited_0, incidents_0) {
    ...
    const incidentScore_0 = ((t1) => {
                              if (t1 > 255n) {
                                throw new __compactRuntime.CompactError('bridgeguard-v2.compact line 179 char 34: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 255');
                              }
                              return t1;
                            })(incidents_0 * 5n);
    ...
    return ((t1) => {
             if (t1 > 255n) {
               throw new __compactRuntime.CompactError('bridgeguard-v2.compact line 182 char 10: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 255');
             }
             return t1;
           })(clamped_0);
  }
  _computeVerdict_0(b_0, amount_0, intel_0) {
    ...
    const total_0 = b_0.riskScore
                    ...
                    ((t1) => {
                      if (t1 > 255n) {
                        throw new __compactRuntime.CompactError('bridgeguard-v2.compact line 192 char 6: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 255');
                      }
                      return t1;
                    })(b_0.incidents * 5n)
                    +
                    ((t1) => {
                      if (t1 > 255n) {
                        throw new __compactRuntime.CompactError('bridgeguard-v2.compact line 193 char 6: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 255');
                      }
                      return t1;
                    })(intel_0 * 8n)
                    +
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'bridgeguard-v2.compact line 73 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    latestVerdicts: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'bridgeguard-v2.compact line 79 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    latestWithin: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'bridgeguard-v2.compact line 80 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
